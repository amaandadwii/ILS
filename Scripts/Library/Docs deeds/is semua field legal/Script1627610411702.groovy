...
WebUI.click(findTestObject('Library/legal/Page_My Task - ILS 2021/a_LibraryLegal'))

WebUI.click(findTestObject('Library/legal/Page_My Task - ILS 2021/a_Comp. Docs. DeedsLegal'))
...
WebUI.scrollToElement(findTestObject('Library/attachment/Page_Comp. Docs. Deeds Library - ILS 2021/label_Attachment'), 0)

WebUI.click(findTestObject('Library/attachment/Page_Comp. Docs. Deeds Library - ILS 2021/label_Attachment'))

//ADD FILE 1
WebUI.click(findTestObject('Library/attachment/Page_Comp. Docs. Deeds Library - ILS 2021/button_Add Attachment'))

WebUI.delay(2)

CustomKeywords.'com.test.uploadFileILS.testclass.uploadFile'(findTestObject('Object Repository/Library/attachment/Page_Comp. Docs. Deeds Library - ILS 2021/button_Choose File'), 
    'D:\\image1.jpg')

WebUI.delay(2)

WebUI.setText(findTestObject('Library/attachment/Page_Comp. Docs. Deeds Library - ILS 2021/textarea_Description_FileDescription'), 
    'attach 1')

WebUI.click(findTestObject('Library/attachment/Page_Comp. Docs. Deeds Library - ILS 2021/button_Add'))
