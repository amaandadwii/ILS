...
WebUI.setText(findTestObject('Object Repository/Library/IP lib/input_Username'), 'mikael.prananta@kalbe.co.id')
...
WebUI.setText(findTestObject('Object Repository/Library/patent/input_Patent Name_PatentDetail_PatentName'), 'name')

WebUI.setText(findTestObject('Object Repository/Library/patent/textarea_Patent Details_PatentDetail_PatentDetails'), 'details')

WebUI.selectOptionByValue(findTestObject('Object Repository/Library/patent/select_Choose your optionA Human Necessitie_f7ca00'), 
    'A', true)

WebUI.click(findTestObject('Object Repository/Library/patent/input__select-dropdownPatentTerritory'))

WebUI.setText(findTestObject('Object Repository/Library/patent/input__searchPatentTerritory'), 'indonesia')

WebUI.click(findTestObject('Object Repository/Library/patent/span_Indonesia'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Library/patent/select_Choose your optionAfghanistanAlbania_c3513b'), 
    'Indonesia', true)
