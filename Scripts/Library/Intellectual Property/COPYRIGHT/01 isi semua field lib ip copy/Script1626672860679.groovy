...
WebUI.click(findTestObject('Library/IP lib/Page_Dispute Settlement Request - ILS 2021/a_Intellectual Property'))
...
WebUI.setText(findTestObject('Object Repository/Library/IP lib/input_Copyright Name_CopyrightDetail_CopyrightName'), 'Copyrigth test ya1.')

WebUI.setText(findTestObject('Object Repository/Library/IP lib/textarea_Copyright Details_CopyrightDetail__072f9d'), 'details copyright 123.')

WebUI.click(findTestObject('Library/IP lib/input__select-dropdownTerritory'))

WebUI.setText(findTestObject('Library/IP lib/input__search.Territory'), 'indon')

WebUI.click(findTestObject('Object Repository/Library/IP lib/span_Indonesia'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Library/IP lib/select_Choose your optionAfghanistanAlbania_c3513b'), 
    'Indonesia', true)
