...
WebUI.selectOptionByValue(findTestObject('Object Repository/Intellectual Property/select_IP registration is instructed       _3bfce3'), 
    'Certificate to be uploaded', true)
...
WebUI.click(findTestObject('Object Repository/Agreement Request/button ok/button_YES'))
