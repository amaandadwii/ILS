...
WebUI.setText(findTestObject('Agreement Request/search/search_box'), '0016/Req.IP/KF/V/2021')

WebUI.verifyElementVisible(findTestObject('Intellectual Property/search/verify data ada'))
