...
WebUI.setText(findTestObject('Agreement Request/search/search_box'), '10  Apr 2021')

WebUI.verifyElementVisible(findTestObject('Intellectual Property/search/verify date'))
