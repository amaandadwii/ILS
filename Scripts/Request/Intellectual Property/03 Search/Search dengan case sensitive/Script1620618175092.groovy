...
WebUI.setText(findTestObject('Agreement Request/search/search_box'), 'industrial design')

WebUI.verifyElementVisible(findTestObject('Intellectual Property/search/verify case sensitive'))
