...
WebUI.click(findTestObject('Intellectual Property/Renewal/Existing Library/trademark/a_DTL1604429504A1'))
...
WebUI.scrollToElement(findTestObject('Intellectual Property/Renewal/Existing Library/trademark/label_Trademark Name'), 0)

WebUI.click(findTestObject('Intellectual Property/Renewal/Existing Library/trademark/label_Trademark Name_form-check-label'))
...
WebUI.click(findTestObject('Intellectual Property/Renewal/Existing Library/trademark/label_Trademark Type_form-check-label'))
...
WebUI.click(findTestObject('Intellectual Property/Renewal/Existing Library/trademark/label_Territory_form-check-label'))
...
WebUI.click(findTestObject('Intellectual Property/Renewal/Existing Library/trademark/label_Change'))
