...
WebUI.setText(findTestObject('Agreement Request/confirmation/input_searchConfirmation'), 'Adelia')

WebUI.click(findTestObject('Agreement Request/confirmation/btn_ConfirmationAdeliaCPKaruna'))
