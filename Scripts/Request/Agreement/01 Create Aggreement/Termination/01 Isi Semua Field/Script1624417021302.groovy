...
WebUI.scrollToElement(findTestObject('Object Repository/Page_Agreement Request - ILS 2021/label_Attachment'), 0)

WebUI.click(findTestObject('Object Repository/Page_Agreement Request - ILS 2021/label_Attachment'))

WebUI.click(findTestObject('Agreement Request/attachment/add_file1'))

//def filePath = RunConfiguration.getProjectDir() + '/1.jpg'
WebUI.uploadFile(findTestObject('Object Repository/Page_Agreement Request - ILS 2021/button_Choose File'), 'D:\\1.jpg')
