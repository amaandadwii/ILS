...
WebUI.click(findTestObject('Agreement Request/Amendment/1/quality agreement/a_010AgrKFIII2021'))
...
WebUI.click(findTestObject('Agreement Request/Amendment/1/quality agreement/label_Duration_form-check-label'))

WebUI.click(findTestObject('Agreement Request/Quality Agreement/select_Year(s)'))

WebUI.setText(findTestObject('Agreement Request/Quality Agreement/input_Duration_QualityAgreement.Duration2New'), '1')

WebUI.click(findTestObject('Agreement Request/Amendment/1/quality agreement/label_Other Notes_form-check-label'))
