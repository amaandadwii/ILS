...
WebUI.setText(findTestObject('Agreement Request/textarea_NotesAgreement'), 'test \' automation')
...
WebUI.setText(findTestObject('Agreement Request/Detail Agreement/input_Packaging Artwork Responsibility'), 'test automation')
