...
WebUI.click(findTestObject('Object Repository/Agreement Request/Registration Agreement/input__select-dropdown form-control'))

WebUI.setText(findTestObject('Object Repository/Agreement Request/Registration Agreement/input__search w-100 d-block'), 
    'Kalbe farma')

WebUI.click(findTestObject('Object Repository/Agreement Request/Registration Agreement/span_PT. Kalbe Farma Tbk'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Agreement Request/Registration Agreement/select_Choose your optionInnogene Kalbiotec_f3d6d9'), 
...
WebUI.click(findTestObject('Agreement Request/Registration Agreement/select_Year(s)'))
