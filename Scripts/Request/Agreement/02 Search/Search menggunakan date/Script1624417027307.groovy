...
WebUI.setText(findTestObject('Agreement Request/search/search_box'), '22 Apr 2021')

WebUI.verifyElementVisible(findTestObject('Agreement Request/search/verify_search date'))
