...
WebUI.setText(findTestObject('Agreement Request/search/search_box'), '017/Req.Agr/KF/III/2021')

WebUI.verifyElementVisible(findTestObject('Agreement Request/search/verify_data ada pada tabel'))
