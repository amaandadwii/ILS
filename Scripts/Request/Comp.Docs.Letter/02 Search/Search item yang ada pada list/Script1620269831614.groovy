...
WebUI.setText(findTestObject('Agreement Request/search/search_box'), '029/Req.Co.Docs-Letter/KF/V/2021')

WebUI.verifyElementVisible(findTestObject('Docs Comp Letter/search/verify_data ada pada list'))
