...
WebUI.setText(findTestObject('Agreement Request/search/search_box'), '06 Apr 2021')

WebUI.verifyElementVisible(findTestObject('Docs Comp Letter/search/verify_date'))
