...
WebUI.setText(findTestObject('Agreement Request/search/search_box'), 'other')

WebUI.verifyElementVisible(findTestObject('Docs Comp Letter/search/verify_case sensitive'))
