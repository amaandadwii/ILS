...
WebUI.executeJavaScript('arguments[0].value=\'2021-12-07\'', Arrays.asList(element))
...
WebUI.setText(findTestObject('Object Repository/Docs Comp Letter/baru/Page_Docs.Letter Request - ILS 2021/textarea_Notes_RequestHeaderDocsLetter.Notes'), 
    'test authorization new (automated)')
...
WebUI.executeJavaScript('arguments[0].value=\'2021-09-07\'', Arrays.asList(element1))
...
WebUI.click(findTestObject('Object Repository/Docs Comp Letter/baru/Page_Docs.Letter Request - ILS 2021/span_Add'))
