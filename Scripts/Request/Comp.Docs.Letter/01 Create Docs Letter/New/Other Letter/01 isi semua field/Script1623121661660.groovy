...
WebUI.setText(findTestObject('Object Repository/Docs Comp Letter/Create Appointment Letter/textarea_Notes_RequestHeaderDocsLetter.Notes'), 
    'Test other letter new (automated)')
...
WebUI.executeJavaScript('arguments[0].value=\'2021-09-12\'', Arrays.asList(element1))
...
WebUI.setText(findTestObject('Docs Comp Letter/other letter/textarea_Notes_OtherLetter'), 'Test Other Letter new (Automated)')
