...
WebUI.click(findTestObject('Docs Comp Letter/Create Appointment Letter/Amendment/authorization/a_002Lib.Co.Docs-LetterKFIV2021'))
...
WebUI.click(findTestObject('Docs Comp Letter/Create Appointment Letter/Amendment/authorization/label_Authorizer_form-check-label'))
...
WebUI.click(findTestObject('Docs Comp Letter/Create Appointment Letter/Amendment/authorization/label_Authorized_form-check-label'))
...
WebUI.click(findTestObject('Docs Comp Letter/Create Appointment Letter/Amendment/authorization/label_Objective_form-check-label'))
...
WebUI.click(findTestObject('Docs Comp Letter/Create Appointment Letter/Amendment/authorization/label_Effective Date_form-check-label'))
...
WebUI.click(findTestObject('Docs Comp Letter/Create Appointment Letter/Amendment/authorization/label_Duration_form-check-label'))
...
WebUI.click(findTestObject('Docs Comp Letter/Create Appointment Letter/Amendment/authorization/label_Notes_form-check-label'))
