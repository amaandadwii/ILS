...
WebUI.click(findTestObject('Docs Comp Letter/Create Appointment Letter/Amendment/othrt/a_004Lib.Co.Docs-LetterKFIV2021'))
...
WebUI.click(findTestObject('Docs Comp Letter/Create Appointment Letter/Amendment/othrt/label_Attention_form-check-label'))

WebUI.setText(findTestObject('Docs Comp Letter/other letter/input_Attention_OtherLetter'), 'Test 123')

WebUI.click(findTestObject('Docs Comp Letter/Create Appointment Letter/Amendment/othrt/label_Objective_form-check-label'))

WebUI.setText(findTestObject('Docs Comp Letter/other letter/textarea_Objective_OtherLetter'), 'objective')

WebUI.click(findTestObject('Docs Comp Letter/Create Appointment Letter/Amendment/othrt/label_Effective Date_form-check-label'))
...
WebUI.executeJavaScript('arguments[0].value=\'2021-06-30\'', Arrays.asList(element1))

WebUI.click(findTestObject('Docs Comp Letter/Create Appointment Letter/Amendment/othrt/label_Duration_form-check-label'))
...
WebUI.click(findTestObject('Docs Comp Letter/Create Appointment Letter/Amendment/othrt/label_Notes_form-check-label'))
