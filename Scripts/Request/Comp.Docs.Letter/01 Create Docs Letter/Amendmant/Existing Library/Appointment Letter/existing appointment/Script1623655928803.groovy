...
WebUI.click(findTestObject('Object Repository/Docs Comp Letter/Create Appointment Letter/Amendment/appointmrent/a_001Lib.Co.Docs-LetterKFIV2021'))
...
WebUI.scrollToElement(findTestObject('Object Repository/Docs Comp Letter/Create Appointment Letter/Amendment/appointmrent/label_Attention'), 
    0)

WebUI.click(findTestObject('Object Repository/Docs Comp Letter/Create Appointment Letter/Amendment/appointmrent/label_Attention_form-check-label'))

WebUI.setText(findTestObject('Object Repository/Docs Comp Letter/Create Appointment Letter/Amendment/appointmrent/input_Attention_AppointmentLetter.AttentionNew'), 
    'attetntions')

WebUI.click(findTestObject('Object Repository/Docs Comp Letter/Create Appointment Letter/Amendment/appointmrent/label_Appointed_form-check-label'))

WebUI.setText(findTestObject('Object Repository/Docs Comp Letter/Create Appointment Letter/Amendment/appointmrent/input_Appointed_AppointmentLetter.AppointedNew'), 
    'check')

WebUI.click(findTestObject('Docs Comp Letter/Create Appointment Letter/Amendment/appointmrent/label_Objective_form-check-label'))

WebUI.setText(findTestObject('Object Repository/Docs Comp Letter/Create Appointment Letter/Amendment/appointmrent/textarea_Objective_AppointmentLetter.ObjectiveNew'), 
    'check')

WebUI.scrollToElement(findTestObject('Object Repository/Docs Comp Letter/Create Appointment Letter/Amendment/appointmrent/label_Duration'), 
    0)

WebUI.click(findTestObject('Docs Comp Letter/Create Appointment Letter/Amendment/appointmrent/label_Duration_form-check-label'))

WebUI.click(findTestObject('Docs Comp Letter/duration/select_year(s)'))

WebUI.setText(findTestObject('Object Repository/Docs Comp Letter/Create Appointment Letter/Amendment/appointmrent/input_Duration_AppointmentLetter.Duration2New'), 
    '2')

WebUI.click(findTestObject('Docs Comp Letter/Create Appointment Letter/Amendment/appointmrent/label_Notes_form-check-label'))

WebUI.setText(findTestObject('Object Repository/Docs Comp Letter/Create Appointment Letter/Amendment/appointmrent/textarea_Notes_AppointmentLetter.NotesNew'), 
    'check')
