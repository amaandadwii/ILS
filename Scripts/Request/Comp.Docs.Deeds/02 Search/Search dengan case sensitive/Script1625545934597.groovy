...
WebUI.setText(findTestObject('Agreement Request/search/search_box'), 'rejected')

WebUI.verifyElementVisible(findTestObject('Agreement Request/search/verify_case sensitive'))
