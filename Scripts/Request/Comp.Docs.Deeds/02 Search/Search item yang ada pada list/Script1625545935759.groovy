...
WebUI.setText(findTestObject('Agreement Request/search/search_box'), '101/Req.Co.Docs-Lgl.Form/KF/VI/2021')

WebUI.verifyElementVisible(findTestObject('Docs Comps Deeds/verify_ada pada list'))
