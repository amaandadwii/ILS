...
WebUI.setText(findTestObject('Agreement Request/search/search_box'), '07 jun 2021')

WebUI.verifyElementVisible(findTestObject('Docs Comps Deeds/verify_datedeeds'))
