...
WebUI.setText(findTestObject('Agreement Request/search/search_box'), '101/Req.Co.Docs-Lgl.Form/KF/VI/2022')

WebUI.verifyElementVisible(findTestObject('Agreement Request/search/verify_data tidak ada pada tabel'))
