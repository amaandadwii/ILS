...
WebUI.setText(findTestObject('Object Repository/Login/input_Username'), 'adelia.theresia@sakafarma.com')
...
WebUI.click(findTestObject('My Task/review 1st draft/btn_review2'))
